...
| [11-rules-act-1.md](11-rules-act-1.md) | **Act I rules design (movie 1):** chapter modes, the kept VPX multiballs, the FREED roster, The One wizard, ball count and build order. Design only, not yet implemented. |
