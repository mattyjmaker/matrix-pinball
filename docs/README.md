...
| [12-rules-terminator-2.md](12-rules-terminator-2.md) | **Game Select and Terminator 2 rules, planned, not yet implemented:** the top-level Matrix / Terminator 2 select, the hardware-from-theme refactor it needs, the physical shot mapping, and the full T2 rule set (chapters, multiballs, SAVED roster, Judgment Day wizard) in the same depth as Act I. |
